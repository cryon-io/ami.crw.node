    ...
    commands = {
        ...
        setup = {
            ...
            action = function(_options, command, args, cli)
                ...
                log_success("CRW node setup complete.")
            end
        },
        start = {
        ...
        validate = {
            ...
            action = function(_options, command, args, cli)
                ...
                ami_assert(fs.EFS, "CRW node AMI requires extra api - eli.fs.extra", EXIT_MISSING_API)
                ...
                log_success("CRW node configuration validated.")
            end
        },
        about = {
